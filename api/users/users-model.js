...
function bul() {
  return db.select("u.user_id", "u.username", "r.role_name").from("users as u").join("roles as r", "u.role_id", "r.role_id");
  /**
...
function goreBul(filtre) {
  return db.select("u.user_id", "u.username", "u.password", "r.role_name").from("users as u").join("roles as r", "u.role_id", "r.role_id").where(filtre);
  /**
